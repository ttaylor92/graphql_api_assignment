defmodule GraphqlApiAssignment.ErrorUtilsTest do
  ...
  test "not_found/2 returns the correct error structure" do
    expected = %{code: :not_found, message: "Resource not found", details: nil}
  ...
  test "internal_server_error/2 returns the correct error structure" do
    expected = %{code: :internal_server_error, message: "An internal error occurred", details: nil}
  ...
  test "not_acceptable/2 returns the correct error structure" do
    expected = %{code: :not_acceptable, message: "Not acceptable", details: nil}
    assert ErrorUtils.not_acceptable("Not acceptable") == expected
  end

  test "conflict/2 returns the correct error structure" do
    expected = %{code: :conflict, message: "Conflict occurred", details: nil}
